...
function bar(): string {
  return `<div class="bar reveal"><a class="brand" href="https://makarima.xyz">m<em>T</em>unnel</a><nav aria-label="Primary navigation"><a href="https://makarima.xyz/docs">docs</a><a href="https://github.com/zul/mtunnel" rel="noreferrer" target="_blank">github</a></nav></div>`;
}

function footer(): string {
  return `<footer class="reveal"><p>Copyright © 2026 mTunnel</p><div class="footer-links"><a class="btn" href="https://makarima.xyz/docs">Docs</a><a class="btn" href="https://makarima.xyz/terms">Terms</a><a class="btn" href="https://github.com/zul/mtunnel" rel="noreferrer" target="_blank">GitHub</a></div></footer>`;
}

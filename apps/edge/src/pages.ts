...
function footer(): string {
  return `<footer class="reveal"><p>Copyright © 2026 makarima.xyz</p><div class="footer-links"><a class="btn" href="https://makarima.xyz/docs">Docs</a><a class="btn" href="https://makarima.xyz/terms">Terms</a><a class="btn" href="https://github.com/zulfaza/mtunnel" rel="noreferrer" target="_blank">GitHub</a></div></footer>`;
}
...
export function landingPage(): Response {
  return page(
    ...
    bar(
      `<a href="#install">Install</a><a href="#use">Use</a><a href="https://makarima.xyz/docs">Docs</a><a href="https://github.com/zulfaza/mtunnel" rel="noreferrer" target="_blank">GitHub</a>`,
    ) +
...
export function docsPage(): Response {
  return page(
    ...
    bar(
      `<a href="https://makarima.xyz/#install">Install</a><a href="https://makarima.xyz/#use">Use</a><a href="https://makarima.xyz/docs">Docs</a><a href="https://github.com/zulfaza/mtunnel" rel="noreferrer" target="_blank">GitHub</a>`,
    ) +

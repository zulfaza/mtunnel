/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 4bbbeef43426c7bdc3416584052d610a)
...
interface __BaseEnv_Env {
  ...
  TUNNELS: DurableObjectNamespace /* TunnelDO from mtunnel-api */;
  REGISTRY: DurableObjectNamespace /* RegistryDO from mtunnel-api */;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      "TUNNEL_DOMAIN" | "PREVIEW_DOMAIN" | "CUSTOM_DOMAIN_CNAME" | "WORKOS_CLIENT_ID"
    >
  > {}
}
